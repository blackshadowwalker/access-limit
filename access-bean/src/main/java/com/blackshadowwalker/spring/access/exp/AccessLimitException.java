package com.blackshadowwalker.spring.access.exp;
...
public class AccessLimitException extends RuntimeException {
    ...
    private AccessLimitOperation limit;
     ...
     * initialized by a call to {@link #initCause}.
     */
    public AccessLimitException(AccessLimitOperation limit) {
        this.limit = limit;
    }
     ...
     *                later retrieval by the {@link #getMessage()} method.
     */
    public AccessLimitException(String message, AccessLimitOperation limit) {
        super(message);
        this.limit = limit;
    }
    ...
    public AccessLimitOperation getLimit() {
        return limit;
    }
}
